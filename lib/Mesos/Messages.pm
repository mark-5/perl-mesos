...
use Google::ProtocolBuffers;
{
    ...
    unless (Mesos::ACL::RunTasks->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'Mesos::ACL::RunTasks',
            [
                [
    ...
    unless (Mesos::ACLs->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            ...
            [
                ...
                [
                    Google::ProtocolBuffers::Constants::LABEL_REPEATED(), 
                    'Mesos::ACL::ReceiveOffers', 
                    'receive_offers', 3, undef
                ],
                [
                    Google::ProtocolBuffers::Constants::LABEL_REPEATED(), 
                    'Mesos::ACL::HTTPGet', 
    ...
    unless (Mesos::ACL::HTTPPut->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'Mesos::ACL::HTTPPut',
            [
                [
    ...
    unless (Mesos::ACL::HTTPGet->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'Mesos::ACL::HTTPGet',
            [
                [
    ...
    unless (Mesos::ACL::ReceiveOffers->can('_pb_fields_list')) {
        Google::ProtocolBuffers->create_message(
            'Mesos::ACL::ReceiveOffers',
            [
                [
